...
(cl:defmethod header-val ((m <motor_throttle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader computer_vision-msg:header-val is deprecated.  Use computer_vision-msg:header instead.")
  (header m))
