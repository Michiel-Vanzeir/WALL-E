...
(cl:defmethod cl:initialize-instance :after ((m <motor_cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motor_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_control-msg:<motor_cmd> is deprecated: use robot_control-msg:motor_cmd instead.")))
