...
class VideoFeedToCommand {
    public:
        SubscribeAndPublish() {
        command_pub = nh_.advertise<std_msgs::String>("motor_controls", 100);
        video_sub = nh_.subscribe("video_feed",30, videoCallback); 
        }
