...
class LaserProcessor {
  ...
  public:
    LaserProcessor() {
      ...
      landmark_pub_ = nh_.advertise<gabby_msgs::LandmarkList>("/slam/landmarks", 10, false);
      ransac = RANSAC(0.015, 0.010, 0.60, 0.04, 150); // (in meters)
      int optimal_iterations = ransac.calculateIterations(2, 0.8);
    ...
    void scanCallback (const sensor_msgs::LaserScan::ConstPtr& scan_in) {
      ...
      gabby_msgs::LandmarkList landmarks = ransac.extractLandmarks(cloud);
