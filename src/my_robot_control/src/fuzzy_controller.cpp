    ...
    private:
     ...
     public:
        FuzzyEngine () {
            ...
            rules->addRule(fl::Rule::parse("if error is nlarge then lthrottle is low and rthrottle is high", engine));         
            ...
            rules->addRule(fl::Rule::parse("if error is large then lthrottle is high and rthrottle is low", engine));
